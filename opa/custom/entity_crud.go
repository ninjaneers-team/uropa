...
// EntityCRUD defines endpoints on Opa's
// Admin API to interact with the Custom entity in Opa.
// Various *Endpoint methods can render
// the endpoint to interact with a custom
// entity in Opa. The RESTful endpoints are dynamically
...
// Type return the type of custom entitiy in Opa.
